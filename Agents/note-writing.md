...
- **Plain third-person, instructional.** No first-person ("I", "me", "my", "we").
...
Every note must open with an **80/20 cheat sheet** section -- a dense block of code or commands that covers 80% of daily usage in 20% of the content. This is the most important section. A future reader should be able to copy-paste from here and be productive immediately.
